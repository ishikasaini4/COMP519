...
public class LRU extends Strategy {
    ...
    public LRU(int size, int nrR, int nrS, int rpbR, int rpbS){
    ...
    public void add(Block block){
        //If Buffer is full, remove least recently used block (from tail of the list)
        if(isFull()) {
            Node rem = removeNode(this.tail.prev);
